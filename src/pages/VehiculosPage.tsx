            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-colors border border-[#25D366]/20"
                >
              ...
              {cliente.nif && (
                <p className="text-xs text-muted-foreground mt-0.5">NIF: {cliente.nif}</p>
              )}
            </div>
          </div>
