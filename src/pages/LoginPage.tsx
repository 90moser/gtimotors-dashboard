      ...
      <div className="flex-[4] bg-background flex items-center justify-center p-8 min-h-screen">
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            className="w-full h-[52px] bg-foreground text-background font-bold rounded-lg flex items-center justify-center gap-3 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed mb-6"
          >
            {googleLoading ? (
